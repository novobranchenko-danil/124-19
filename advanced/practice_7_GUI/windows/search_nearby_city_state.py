...
################################################################################
## Form generated from reading UI file 'search_nearby_city_state.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.state_input = QLineEdit(self.groupBox)
        self.state_input.setObjectName(u"state_input")

        self.verticalLayout.addWidget(self.state_input)

        self.city_input = QLineEdit(self.groupBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Search nearby State and City", None))
        self.groupBox.setTitle("")
        self.state_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"State", None))
        self.city_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"City", None))
