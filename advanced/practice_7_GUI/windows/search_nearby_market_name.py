...
################################################################################
## Form generated from reading UI file 'search_nearby_market_name.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.market_name_input = QLineEdit(self.groupBox)
        self.market_name_input.setObjectName(u"market_name_input")

        self.verticalLayout.addWidget(self.market_name_input)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Search nearby Market Name", None))
        self.groupBox.setTitle("")
        self.market_name_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Enter market name or part of it  ", None))
