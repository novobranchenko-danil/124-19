...
################################################################################
## Form generated from reading UI file 'search_all_market.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.back_page_button = QPushButton(self.groupBox_2)
        self.back_page_button.setObjectName(u"back_page_button")

        self.horizontalLayout_3.addWidget(self.back_page_button)

        self.pagination_info = QLabel(self.groupBox_2)
        self.pagination_info.setObjectName(u"pagination_info")
        self.pagination_info.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_3.addWidget(self.pagination_info)

        self.next_page_button = QPushButton(self.groupBox_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"All Markets", None))
        self.groupBox.setTitle("")
        self.groupBox_2.setTitle("")
        self.back_page_button.setText(QCoreApplication.translate("MainWindow", u"\u2190 Back", None))
        self.pagination_info.setText(QCoreApplication.translate("MainWindow", u"\u0421\u0442\u0440\u0430\u043d\u0438\u0446\u0430 1/2", None))
        self.next_page_button.setText(QCoreApplication.translate("MainWindow", u"Next \u2192", None))
