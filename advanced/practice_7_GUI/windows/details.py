...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.view_review_button = QPushButton(self.groupBox_2)
        self.view_review_button.setObjectName(u"view_review_button")

        self.horizontalLayout.addWidget(self.view_review_button)

        self.leave_review_button = QPushButton(self.groupBox_2)
        self.leave_review_button.setObjectName(u"leave_review_button")

        self.horizontalLayout.addWidget(self.leave_review_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Details", None))
        self.groupBox.setTitle("")
        self.groupBox_2.setTitle("")
        self.view_review_button.setText(QCoreApplication.translate("MainWindow", u"View review", None))
