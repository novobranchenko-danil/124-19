...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.confirm_password_input = QLineEdit(self.groupBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.confirm_password_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Confirm password  ", None))
