...
################################################################################
## Form generated from reading UI file 'search_nearby_zip.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.zip_input = QLineEdit(self.groupBox)
        self.zip_input.setObjectName(u"zip_input")

        self.verticalLayout.addWidget(self.zip_input)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Search nearby ZIP", None))
        self.groupBox.setTitle("")
        self.zip_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"ZIP", None))
